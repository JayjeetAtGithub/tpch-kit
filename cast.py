...
if __name__ == "__main__":
    ...
    if filepath.endswith("lineitem.parquet"):
        ...
        df["l_shipdate"] = df["l_shipdate"].astype("datetime64[s]")
        df["l_commitdate"] = df["l_commitdate"].astype("datetime64[s]")
        df["l_receiptdate"] = df["l_receiptdate"].astype(" datetime64[s]")
